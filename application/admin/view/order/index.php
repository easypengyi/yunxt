            ...
            <form class="form-search" method="get" action="{$current_url}">
                <div class="col-xs-12 col-sm-12 col-md-6 margintop5">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3">
                        <label for="status">
                            <select name="status" id="status" data-href="{:folder_url('Ajax/select_order_status',['id'=>$search.status])}" class="col-xs-10 col-sm-5 selectpicker select-ajax" title="按状态"></select>
                        </label>
                    </div>
                </div>
