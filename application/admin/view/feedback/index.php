...
<?php isset($app_type) OR $app_type = []; ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="hidden-sm hidden-xs action-buttons action-buttons-list">
                                            <a href="{:folder_url('Common/feedback_detail',['id'=>$v.feedback_id])}" class="detail-btn" data-toggle="tooltip" title="详情">
                                                <span class="blue"><i class="ace-icon fa fa-sticky-note bigger-130"></i></span>
                                            </a>
                                            <a href="{:controller_url('del',['id'=>$v.feedback_id])}" class="confirm-rst-url-btn" data-toggle="tooltip" title="删除" data-info="你确定要删除吗？">
