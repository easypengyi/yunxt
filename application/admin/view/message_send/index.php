                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="hidden-sm hidden-xs action-buttons action-buttons-list">
                                            <a href="{:controller_url('copy',['id'=>$v.send_id])}" data-toggle="tooltip" title="复制">
                                                <span class="green"><i class="ace-icon fa fa-exchange bigger-130"></i></span>
                                            </a>
                                            <a href="{:controller_url('del',['id'=>$v.send_id])}" class="confirm-rst-url-btn" data-info="你确定要删除吗？" data-toggle="tooltip" title="删除">
