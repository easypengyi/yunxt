...
<div class="page-content">
    <div class="row maintop">
        <div class="col-xs-12 col-sm-2 col-md-1 margintop5">
            <a href="{:controller_url(['add',['type'=>$type]])}" class="btn btn-sm btn-danger">添加</a>
        </div>
            ...
            <form class="form-search" method="get" action="{$current_url}">
                ...
                <div class="col-xs-12 col-sm-10 col-md-5 margintop5">
                    <div class="input-group">
                        ...
                        <input type="text" name="keyword" id="keyword" class="form-control" value="{$search.keyword}" placeholder=""/>
                        ...
                        <tbody>
                            <?php foreach ($data_list as $v) : ?>
                                <tr>
                                    ...
                                    <td>{$v.sort}</td>
                                    <td>
                                        <a class="red open-btn" href="{:controller_url(['change_enable',['type'=>$type]])}" data-id="{$v.button_id}" data-status="{$v.enable}">
                                            <div>
                                    ...
                                    <td>
                                        <div class="hidden-sm hidden-xs action-buttons action-buttons-list">
                                            <a href="{:controller_url(['edit',['type'=>$type]],['id'=>$v.button_id])}" data-toggle="tooltip" title="修改">
                                                <span class="green"><i class="ace-icon fa fa-pencil bigger-130"></i></span>
                                            </a>
                                            <a href="{:controller_url(['del',['type'=>$type]],['id'=>$v.button_id])}" class="confirm-rst-url-btn" data-info="你确定要删除吗？" data-toggle="tooltip" title="删除">
