                        ...
                        <tbody>
                            <?php foreach ($data_list as $v) : ?>
                                <tr>
                                    ...
                                    <td>{$v.sort}</td>
                                    <td>
                                        <a class="red open-btn" href="{:controller_url('change_enable')}" data-id="{$v.article_id}" data-status="{$v.enable}">
                                            <div>
                                    ...
                                    <td>
                                        <div class="hidden-sm hidden-xs action-buttons action-buttons-list">
                                            <a href="{:controller_url(['edit',['type'=>$type]],['id'=>$v.article_id])}" data-toggle="tooltip" title="修改">
                                                <span class="green"><i class="ace-icon fa fa-pencil bigger-130"></i></span>
                                            </a>
                                            <a href="{:controller_url(['del',['type'=>$type]],['id'=>$v.article_id])}" class="confirm-rst-url-btn" data-info="你确定要删除吗？" data-toggle="tooltip" title="删除">
